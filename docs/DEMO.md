...
Doğrulanan kod: `demo-candidate-20260922-v8` (uygulama commit’i `0787bcb`).
Test kanıtı: `reports/v8_ceiling_full.txt` — izole PostgreSQL üzerinde 402 passed, 22 golden dahil.
...
| 2:35–3:00 | v8_ceiling_full.txt ve v8_ceiling_golden.json | “402 backend testi ve 22 golden senaryo. Gerçek PostgreSQL; tool girdileri, yasak etkiler, kaynaklar ve DB sonucu birlikte kontrol edildi.” |
...
## v8 çekim öncesi kabul

Fiyat ayrıştırıcısı v8 ile yeniden **DONDURULDU**. `8K TL’ye kadar endüstriyel barkod okuyucu öner.` ve `sekiz yüz liraya kadar kılıf öner.` netleştirme ister; öneri/arama yapılmaz.
