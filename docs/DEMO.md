...
Doğrulanan kod: `demo-candidate-20260922-v4` (uygulama commit’i `902894a`).
Test kanıtı: `reports/safety_review_full_backend.txt` — izole PostgreSQL üzerinde 294 passed, 22 golden dahil.
...
| 2:35–3:00 | safety_review_full_backend.txt ve safety_review_golden.json | “294 backend testi ve 22 golden senaryo. Gerçek PostgreSQL; tool girdileri, yasak etkiler, kaynaklar ve DB sonucu birlikte kontrol edildi.” |
