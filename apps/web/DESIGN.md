...
Mavi ve kırmızı marka renkleri, serin nötr yüzeyler üzerinde kullanılır. Frontmatter mevcut CSS değerlerini kaydeder; uygulamadaki kaynak `src/style.css` dosyasıdır.

- **Primary — İşlem mavisi:** Birincil buton, bağlantı, odak halkası ve gezinme vurgusu.
- **Secondary — Marka kırmızısı:** Marka adı ve geçersiz alan kenarlığı. Hata metni ayrı `error-ink` tonunu kullanır.
...
1180px ve altında çalışma panelleri tek sütuna, form üç sütundan ikiye geçer; sayfa dolgusu 24px olur. 700px ve altında gezinme üstte yatay kaydırılabilir sıraya, form tek sütuna geçer; sayfa yatay dolgusu 16px, panel dolgusu 18px olur. Tablolar kendi kapsayıcısında yatay kayar. Sohbet alanı masaüstünde 480px, ara genişlikte 400px, dar ekranda 360px yüksekliğinde kaydırılır.
...
- **Gezinme:** Sol menüde etkin sayfa açık mavi yüzey, koyu mavi yazı ve `aria-current` ile belirtilir. Dar ekranda yatay sıra korunur.
