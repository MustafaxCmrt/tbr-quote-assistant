...
> **Güncel durum (2026-09-23, v11):** uygulama `05fe5cd`, tam backend **762 passed** (22 golden, 83 + 126 yeniden denetim denemesi ve 32 kendi probe dahil),
> istemciler 25 passed; [ikinci yeniden denetim çözüm kaydı](reaudit2_fix_resolution.md), [ilk yeniden denetim](reaudit_fix_resolution.md), [ilk denetim](audit_fix_resolution.md). Aşağıdaki tablo tarihsel F00–F08 kabul kaydıdır; sayılar kendi commit'lerine aittir.
