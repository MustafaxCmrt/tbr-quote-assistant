...
- Doğrulanan uygulama `fde6015`: 451 backend testi (22 golden dahil), 0 error; [son rapor](reports/audit_fix_resolution.md). Önceki v8 `0787bcb`: 402 ([rapor](reports/final_ceiling_resolution.md)).
