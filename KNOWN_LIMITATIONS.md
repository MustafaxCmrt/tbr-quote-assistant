...
- Doğrulanan uygulama `05fe5cd`: 762 backend testi (22 golden + 83 ilk ve 126 ikinci yeniden denetim denemesi + 32 kendi probe dahil), 0 error; [son rapor](reports/reaudit2_fix_resolution.md). Önceki `3e5aa4d`: 604 ([rapor](reports/reaudit_fix_resolution.md)); `fde6015`: 451; v8 `0787bcb`: 402.
